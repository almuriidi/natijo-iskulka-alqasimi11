...
<html lang="en">
    <head>
        ...
        <title>Ogaanshaha Natiijada Ardada</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-12">
                                    <h2 class="title" align="center">Ogaanshaha Natiijada Ardada</h2>
                                </div>
                            </div>
                            <!-- /.row -->
...
{   ?>
<p><b>Magaca Ardayga/Ardayada :</b> <?php echo htmlentities($row->StudentName);?></p>
<p><b>Lambarka Ardayga/Ardayada :</b> <?php echo htmlentities($row->RollId);?>
<p><b>Fasalka Ardayga/Ardayada:</b> <?php echo htmlentities($row->ClassName);?>(<?php echo htmlentities($row->Section);?>)
<?php }
...
?>
<tr>
                                                <th scope="row" colspan="2">Wadarta Natiijada</th>
<td><b><?php echo htmlentities($totlcount); ?></b> / <b><?php echo htmlentities($outof=($cnt-1)*100); ?></b></td>
                                                        </tr>
<tr>
                                                <th scope="row" colspan="2">Celcelis</th>           
                                                            <td><b><?php echo  htmlentities($totlcount*(100)/$outof); ?> %</b></td>
                                                             </tr>
<tr>
                                                <th scope="row" colspan="2">Soodagso Natiijada</th>           
                                                            <td><b><a href="download-result.php">Soodaji </a> </b></td>
                                                             </tr>

 <?php } else { ?>     
<div class="alert alert-warning left-icon-alert" role="alert">
                                            <strong>Ogeysiis!</strong> Wali Natiijo Laguu ma soo galinin
 <?php }
?>
                                        </div>
 <?php 
...
Iska hubi Lambarkaaga ama Fasalkaaga</strong>
<?php
...
?>
                                    ...
                                    <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                               <a href="index.php">Dib u laabo</a>
                                                            </div>
                                                        </div>
